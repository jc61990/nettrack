...
# DNF already provided: sqlalchemy, psycopg2, pyyaml, requests, httpx, cryptography, bcrypt, pydantic, jose
...
# Only pure-Python packages — compiled deps installed via dnf above
$PIP \
    "fastapi==0.115.5" \
